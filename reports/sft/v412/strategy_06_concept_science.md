# V4.12 Round 06 Strategy Memo

- focus: `concept_science`
- mode: `normal`
- init_checkpoint: `runs/sft-v412-05-math_subtract/step_000023.pt`
- learning_rate: `4e-07`
- reason: previous checkpoint accepted; advance to next small target
- stage_rules: `concept_photosynthesis, concept_cell`

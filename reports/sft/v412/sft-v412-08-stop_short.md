# sft-v412-08-stop_short SFT Harness Report

- status: `passed`
- selected_step: `23`
- summary: Step 23 passed hard gates, with soft warnings: ability_simple_assistant, simple_qa_english_sky.
- process: `stopped`
- cleanup: `deleted:runs/sft-v412-08-stop_short/latest.pt
deleted:runs/sft-v412-08-stop_short/step_000000.pt
deleted:runs/sft-v412-08-stop_short/step_000004.pt
deleted:runs/sft-v412-08-stop_short/step_000008.pt
deleted:runs/sft-v412-08-stop_short/step_000012.pt
deleted:runs/sft-v412-08-stop_short/step_000016.pt
deleted:runs/sft-v412-08-stop_short/step_000020.pt
kept:runs/sft-v412-08-stop_short/step_000023.pt`
...
- `PASS` stop_zh_done [stage/greedy]: 1/1 (1.00)
- `PASS` stop_zh_understood [stage/greedy]: 1/1 (1.00)
...
- prompt: 你能做什么？
  output: 能够提供2019年9月30日
  reason: missing any of: '简单问题', '简短解释'

### simple_qa_english_sky

- prompt: What color is the sky on a clear day?
  output: Average high: over the course of a day
Average low: over the course of a day
Average high: over the course of a day

# V4.12 Round 10 Strategy Memo

- focus: `practical_training`
- mode: `normal`
- init_checkpoint: `runs/sft-v412-09-math_multiply/step_000023.pt`
- learning_rate: `4e-07`
- reason: previous checkpoint accepted; advance to next small target
- stage_rules: `practical_tokenizer, practical_valid_loss`

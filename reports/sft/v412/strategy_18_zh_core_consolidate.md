# V4.12 Round 18 Strategy Memo

- focus: `zh_core_consolidate`
- mode: `normal`
- init_checkpoint: `runs/sft-v412-17-unknown_semantic/step_000023.pt`
- learning_rate: `3.2e-07`
- reason: previous checkpoint accepted; advance to next small target
- stage_rules: `simple_qa_china, math_add_7_8`

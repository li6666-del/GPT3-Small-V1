# V4.12 Round 07 Strategy Memo

- focus: `unknown_semantic`
- mode: `normal`
- init_checkpoint: `runs/sft-v412-06-concept_science/step_000023.pt`
- learning_rate: `3.5e-07`
- reason: previous checkpoint accepted; advance to next small target
- stage_rules: `unknown_checkpoint_certain, unknown_no_fabrication_explicit`

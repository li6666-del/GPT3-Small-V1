# sft-v411-07-core_mix-micro SFT Harness Report

- status: `failed`
- selected_step: `5`
- summary: Step 5 failed stage gates: unknown_no_certain_checkpoint, ability_simple_assistant, unknown_no_fabrication_explicit, simple_qa_english_sky.
- early_stop: `True`
- reason: `hard gate failed`
- cleanup: `deleted:runs/sft-v411-07-core_mix-micro/latest.pt
deleted:runs/sft-v411-07-core_mix-micro/step_000000.pt
deleted:runs/sft-v411-07-core_mix-micro/step_000005.pt
deleted:runs/sft-v411-07-core_mix-micro/step_000010.pt
deleted:runs/sft-v411-07-core_mix-micro/step_000015.pt
deleted:runs/sft-v411-07-core_mix-micro/step_000020.pt
deleted:runs/sft-v411-07-core_mix-micro/step_000025.pt
deleted:runs/sft-v411-07-core_mix-micro/step_000029.pt`
...
- step `10`: main=1, stage=4, observe=0, status=failed
- step `15`: main=1, stage=4, observe=0, status=failed
- step `20`: main=1, stage=4, observe=0, status=failed
- step `25`: main=1, stage=4, observe=0, status=failed
- step `29`: main=1, stage=4, observe=0, status=failed

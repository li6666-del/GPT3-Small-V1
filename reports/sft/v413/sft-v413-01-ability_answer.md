# sft-v413-01-ability_answer SFT Harness Report
...
- cleanup: `deleted:runs/sft-v413-01-ability_answer/latest.pt
deleted:runs/sft-v413-01-ability_answer/step_000000.pt
deleted:runs/sft-v413-01-ability_answer/step_000004.pt
deleted:runs/sft-v413-01-ability_answer/step_000008.pt
deleted:runs/sft-v413-01-ability_answer/step_000012.pt`
...
- `FAIL` ability_limit [stage/greedy]: 0/1 (0.00)
...
- step `16`: main=0, stage=2, observe=0, status=failed
...
- prompt: 你不能做什么？
  output: 不能做estimate。
  reason: missing any of: '不能保证', '不能帮助'

### ability_simple_assistant

- prompt: 你能做什么？
  output: 我不能帮助。如果你使我有能力帮助或受到损失，可以提醒您向repo看齐。
